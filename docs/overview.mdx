...
| --- | --- |
| Face (FaceNet‑128, 2‑bit quant.) | ≈ 11–26 bits |
| Any generic object | ≈ 20 bits |
| Face + object | ≈ 46 bits |
| Password to fill the gap | 11 random ASCII chars (≈ 66 bits) |
| Optional PoW (2¹⁶ space, Argon2id ≈ 5 try/s) | 3 h of brute force to receive additional 16 and resulting 128 bits of security |
